...
//TimeFrame 60   
 ...
 if ((Min==00))  {  OpenOrder_60=false;}
  ...
  if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&(TM5==true)&&((MA5+filtr_5*Point*k)<Close[1])&&(ATR5>0.0002)&&(WPR5<-95)&&(CCI5<-95)) { 
  Start5=CloseAt_5;
  ...
  if(    OrderSend(Symbol(),OP_BUY,lot*Kof,Ask,Slipage*k,NULL,NULL,"M5",Magic_Number,0,Blue) < 0) 
      ...
      else {BM5=true;OpenOrder_5=true;SendMail("MixSystems Buy"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  }
  
  if (((Min==15)||(Min==30)||(Min==45)||(Min==00))&&(TM15==true)){
    if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA15+filtr_15*Point*k)<Close[1])&&(ATR15>0.0002)&&(WPR15<-95)&&(CCI15<-95)) { 
  Start15=CloseAt_15;
  ...
  if(    OrderSend(Symbol(),OP_BUY,lot*Kof,Ask,Slipage*k,NULL,NULL,"M15",Magic_Number,0,Blue) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }   else {BM15=true;OpenOrder_15=true;SendMail("MixSystems Buy"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  }}
   if (((Min==30)||(Min==00))&&(TM30==true)) {
    if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA30+filtr_30*Point*k)<Close[1])&&(ATR30>0.0002)&&(WPR30<-95)&&(CCI30<-95)) { 
  Start30=CloseAt_30;
  ...
  if(    OrderSend(Symbol(),OP_BUY,lot*Kof,Ask,Slipage*k,NULL,NULL,"M30",Magic_Number,0,Blue) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }   else {BM30=true;OpenOrder_30=true;SendMail("MixSystems Buy"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  }}
   if (((Min==00))&&(TM60==true)) {
    if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA60+filtr_60*Point*k)<Close[1])&&(ATR60>0.0002)&&(WPR60<-95)&&(CCI60<-95)) { 
  Start60=CloseAt_60;
  ...
  if(    OrderSend(Symbol(),OP_BUY,lot*Kof,Ask,Slipage*k,NULL,NULL,"M60",Magic_Number,0,Blue) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }   else {BM60=true;OpenOrder_60=true;SendMail("MixSystems Buy"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  }}
  
  
   if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&(TM5==true)&&((MA5-filtr_5*Point*k)>Close[1])&&(ATR5>0.0002)&&(WPR5>-5)&&(CCI5>90)) { 
   Start5=CloseAt_5;
  ...
  if(    OrderSend(Symbol(),OP_SELL,lot*Kof,Bid,Slipage*k,NULL,NULL,"M5",Magic_Number,0,Red) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }   else {SM5=true;OpenOrder_5=true;SendMail("MixSystems Sell"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  } 
  if (((Min==15)||(Min==30)||(Min==45)||(Min==00))&&(TM15==true)){
  if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA15-filtr_15*Point*k)>Close[1])&&(ATR15>0.0002)&&(WPR15>-5)&&(CCI15>90)) { 
   Start15=CloseAt_15;
  ...
  if(    OrderSend(Symbol(),OP_SELL,lot*Kof,Bid,Slipage*k,NULL,NULL,"M15",Magic_Number,0,Red) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }else {SM15=true;OpenOrder_15=true;SendMail("MixSystems Sell"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  } }
   if (((Min==30)||(Min==00))&&(TM30==true)) {
    if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA30-filtr_30*Point*k)>Close[1])&&(ATR30>0.0002)&&(WPR15>-5)&&(CCI30>90)) { 
   Start30=CloseAt_30;
  ...
  if(    OrderSend(Symbol(),OP_SELL,lot*Kof,Bid,Slipage*k,NULL,NULL,"M30",Magic_Number,0,Red) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }else {SM30=true;OpenOrder_30=true;SendMail("MixSystems Sell"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  } }
   if (((Min==00))&&(TM60==true)) {
    if ((OpenOrder_5==false)&&(OpenOrder_15==false)&&(OpenOrder_30==false)&&(OpenOrder_60==false)&&((MA60-filtr_60*Point*k)>Close[1])&&(ATR60>0.0002)&&(WPR60>-5)&&(CCI60>90)) { 
   Start60=CloseAt_60;
  ...
  if(    OrderSend(Symbol(),OP_SELL,lot*Kof,Bid,Slipage*k,NULL,NULL,"M60",Magic_Number,0,Red) < 0) 
      { 
        Alert("Ошибка открытия позиции № ", GetLastError());
      }else {SM60=true;OpenOrder_60=true;SendMail("MixSystems Sell"+Symbol(),MarketInfo(Symbol(),MODE_SPREAD));}
  }   }
